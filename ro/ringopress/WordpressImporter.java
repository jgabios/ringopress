...
public class WordpressImporter {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select post_title,post_content,post_date,ID from b2_bashposts where post_status='publish'");
            while (rs.next()) {
                ...
                ResultSet rsComment = stComment.executeQuery("select comment_author,comment_author_email,comment_date,comment_author_url,comment_content from b2_bashcomments where comment_approved = 1 and comment_post_ID = " + postId);
    ...
    public static void postData(String data) {
        ...
        browser.setConnectionFromURL("http://127.0.0.1:8080/importPosts");
